...
function fp(){
  ...
  if(r==true){
  document.getElementById("3").innerHTML="Given string is palindrome";
}
else{
 document.getElementById("3").innerHTML="Given string is not a palindrome";
...
function fl(){
  ...
  if(rr==true){
    document.getElementById('4').innerHTML="Given string is a Anagram ";
  }
  else{
    document.getElementById('4').innerHTML="Given string is not a Anagram ";``
  }
...
function myfun() {
  ...
  document.getElementById("e").value = Math.floor(Math.random() * 1000);
  document.getElementById("h").value = Math.floor(Math.random() * 1000);
  var map1=new Map();
  map1.set("0","Human");
...
function g(){
  ...
  if(p==2){
    document.getElementById('m').innerHTML="HUMAN SURVIVES";
  }
  if(p==3){
    document.getElementById('m').innerHTML="COCKROACH SURVIVES";
  }
  if(p==4){
    document.getElementById('m').innerHTML="HUMAN DIES";
  }
}
